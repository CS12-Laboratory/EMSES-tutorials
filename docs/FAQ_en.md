Lang: [日本語](FAQ.md) | [English](FAQ_en.md)

# FAQ

This page collects setup checks and repair notes that are useful only when something goes wrong. In the usual path, follow the [Quick Start](QuickStart_en.md).
